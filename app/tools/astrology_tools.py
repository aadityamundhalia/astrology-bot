...
class AstrologyTools:
    ...
    async def today_prediction(
        self,
        astrology_service,
        date_of_birth: Annotated[str, "Date of birth in YYYY-MM-DD format"],
        time_of_birth: Annotated[str, "Time of birth in HH:MM format"],
        place_of_birth: Annotated[str, "Place of birth (City, Region)"]
    ) -> str:
        ...
        try:
            ...
            result = await astrology_service.get_today_prediction(birth_data)
            return str(result)
    ...
    async def weekly_prediction(
        ...
        try:
            ...
            result = await astrology_service.get_weekly_prediction(birth_data)
            return str(result)
        except Exception as e:
    ...
    async def current_month_prediction(
        self,
        astrology_service,
        date_of_birth: Annotated[str, "Date of birth in YYYY-MM-DD format"],
        time_of_birth: Annotated[str, "Time of birth in HH:MM format"],
        ...
        try:
            ...
            result = await astrology_service.get_current_month_prediction(birth_data)
            return str(result)
        except Exception as e:
    ...
    async def quarterly_prediction(
        self,
        astrology_service,
        date_of_birth: Annotated[str, "Date of birth in YYYY-MM-DD format"],
        time_of_birth: Annotated[str, "Time of birth in HH:MM format"],
        ...
        try:
            ...
            result = await astrology_service.get_quarterly_prediction(birth_data)
            return str(result)
        except Exception as e:
    ...
    async def yearly_prediction(
        ...
        try:
            ...
            result = await astrology_service.get_yearly_prediction(birth_data)
            return str(result)
        except Exception as e:
    ...
    async def love_prediction(
        ...
        try:
            ...
            result = await astrology_service.get_love_prediction(birth_data, start, end)
            return str(result)
        except Exception as e:
    ...
    async def career_prediction(
        ...
        try:
            ...
            result = await astrology_service.get_career_prediction(birth_data, start, end)
            return str(result)
        except Exception as e:
    ...
    async def wealth_prediction(
        ...
        try:
            ...
            result = await astrology_service.get_wealth_prediction(birth_data, start, end)
            return str(result)
        except Exception as e:
    ...
    async def health_prediction(
        ...
        try:
            ...
            result = await astrology_service.get_health_prediction(birth_data, start, end)
            return str(result)
        except Exception as e:
    ...
    async def wildcard_prediction(
        ...
        try:
            ...
            result = await astrology_service.get_wildcard_prediction(birth_data, query, date)
            return str(result)
        except Exception as e:
    ...
    async def daily_horoscope(
        ...
        try:
            ...
            result = await astrology_service.get_daily_horoscope(birth_data)
            return str(result)
        except Exception as e:
    ...
    async def weekly_horoscope(
        ...
        try:
            ...
            result = await astrology_service.get_weekly_horoscope(birth_data)
            return str(result)
        except Exception as e:
    ...
    async def monthly_horoscope(
        ...
        try:
            ...
            result = await astrology_service.get_monthly_horoscope(birth_data)
            return str(result)
        except Exception as e:
